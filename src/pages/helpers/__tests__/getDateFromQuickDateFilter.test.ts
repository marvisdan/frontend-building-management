...
import { getDateFromQuickDateFilter } from "../getDateFromQuickDateFilter";

describe("getDateFromQuickDateFilter", () => {
  ...
  it.skip('should return all data when date is "all"', () => {
    const result = getDateFromQuickDateFilter({
      data: mockData,
      dateFilter: "all",
      currentDate,
    });
  ...
  it.skip('should filter data for "week"', () => {
    const result = getDateFromQuickDateFilter({
      data: mockData,
      dateFilter: "week",
      currentDate,
  ...
  it.skip('should filter data for "two_weeks"', () => {
    const result = getDateFromQuickDateFilter({
      data: mockData,
  ...
  it.skip('should filter data for "month"', () => {
    const result = getDateFromQuickDateFilter({
      data: mockData,
      dateFilter: "month",
      currentDate,
  ...
  it.skip('should filter data for "three_months"', () => {
    const result = getDateFromQuickDateFilter({
      data: mockData,
